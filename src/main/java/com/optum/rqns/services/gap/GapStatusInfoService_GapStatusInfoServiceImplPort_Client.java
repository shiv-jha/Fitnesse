...
import com.optum.rqns.services.gap.GapStatusInfoService;
import com.optum.rqns.services.gap.GapStatusInfoServiceImpl;
import com.optum.rqns.services.utils.DataBaseConnect;

/**
 * This class was generated by Apache CXF 2.7.18
 * 2017-08-03T15:51:15.735+05:30
...
public final class GapStatusInfoService_GapStatusInfoServiceImplPort_Client {
    ...
    private static com.optum.rqns.services.gap.GapStatusInfo _addGapStatusInfo_gapStatusInfo=null;
    ...
    public  String gapService() throws java.lang.Exception {
        ...
        com.optum.rqns.services.gap.ServiceMetaData _addGapStatusInfo_serviceMetaData = new com.optum.rqns.services.gap.ServiceMetaData();
        _addGapStatusInfo_serviceMetaData.setAppId("01d3fccafdd317b776011bfd3a695ce7");
      
        
         _addGapStatusInfo_gapStatusInfo = new com.optum.rqns.services.gap.GapStatusInfo();
        ...
        ResultSet rs=DataBaseConnect.getRsList("STAGE-DW", "select count(*) from A_MBR_RVW_RSLT where GAP_ID='"+"Gap"+sRandomId+"'");
        int iCount=0;
         while (rs.next()){
         	iCount = rs.getInt(1);
         }
         ...
         if (iCount==1)
         {
         	ResultSet rs1=DataBaseConnect.getRsList("STAGE-DW", "select * from A_MBR_RVW_RSLT where GAP_ID='"+"Gap"+sRandomId+"'");
         	 while (rs1.next()){
