...
public class EtlJobRun {
	...
	try
	{
		msg=etl.runJobWithUserPassJobStnTable("dsivapur", "Dhyanam#17", "PAY_PAY_JS_M_CLM", "APSRD5785", "PAY_PAY_VAR_TST");
	}
	catch(Exception e)
	{
       ...
       // System.setProperty("webdriver.ie.driver", properties.getProperty("ie.driver"));
		...
		//driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		  try {
			...
			// new Select (driver.findElement(By.id("modeling_EngineWidget"))).selectByIndex(1);
			 try
			 {
				 if(sTable.equals("PAY_PAY_VAR"))
				 {
					 new Select(driver.findElement(By.xpath("//select[contains(@id, 'WDWCB')]"))).selectByValue("8");
				 }
				 else
				 {
					 new Select(driver.findElement(By.xpath("//select[contains(@id, 'WDWCB')]"))).selectByValue("4");
				 }
			 }
			 catch(Exception e)
			 {
			 ...
			 driver.findElement(By.xpath("//input[contains(@id, 'PanelSubmitJobStream_2_StringJobStream')]")).sendKeys(sJob);
			   ...
			   // t(By.id("logout_nav_action")).click();
			    msg="Job: "+ sJob +" is successfully submitted";
			    driver.close();
			    driver.quit();
	...
	public  String runIndividualJobWithUserPassJobStnTable(String sUser,String sPass,String sJob ,String sWorkstn,String sTable) throws AWTException, InterruptedException {
		 WebDriver driver;
		System.setProperty("webdriver.ie.driver","E:/Eclipse/Project/Resources/IEDriverServer.exe");
		//System.setProperty("webdriver.ie.driver",conf.iedriver);
		DesiredCapabilities capabilities = DesiredCapabilities.internetExplorer();
		  ...
		  try {
			...
			// new Select (driver.findElement(By.id("modeling_EngineWidget"))).selectByIndex(1);
			 try
			 {
				 ...
				 {
					 new Select(driver.findElement(By.xpath("//select[contains(@id, 'WDWCB')]"))).selectByValue("0");
				 }
			 }
			 catch(Exception e)
			 {
			 ...
			 driver.findElement(By.xpath("//input[contains(@id, 'ButtonOK_action')]")).click();
			 
			// StringJob_value
			 //StringVariableTable_value
			 
			 //StringWorkstationJob_value
			 //StringJobStream_value
			 
			 //StringWorkstation_value
			 
			 //ButtonOK_action
			 Thread.sleep(4000);
			 driver.findElement(By.xpath("//input[contains(@id, 'StringJob_value')]")).sendKeys(sJob);
			 driver.findElement(By.xpath("//input[contains(@id, 'StringVariableTable_value')]")).sendKeys(sTable);
			 driver.findElement(By.xpath("//input[contains(@id, 'StringWorkstationJob_value')]")).sendKeys(sWorkstn);
			 driver.findElement(By.xpath("//input[contains(@id, 'StringJobStream_value')]")).sendKeys("JOBS");
			 driver.findElement(By.xpath("//input[contains(@id, 'StringWorkstation_value')]")).sendKeys(sWorkstn);
			   // driver.findElement(By.xpath("//td[2]/input")).sendKeys(sJob);
			   // msg="8";
			    //msg=driver.getPageSource();
...
//			    driver.findElement(By.xpath("//input[contains(@name, 'PanelSubmitJobStream_2_StringVariableTable')]")).sendKeys(sTable);
//			    msg="10";
			    driver.findElement(By.xpath("//*[contains(@id, 'ButtonOK_action')]")).click();
//			    msg="11";
			    Thread.sleep(10000);
//			    driver.findElement(By.xpath("//*[contains(@id, 'Button0_action')]")).click();
//			   // driver.findElement(By.id("logout_nav_action")).click();
