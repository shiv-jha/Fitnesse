...
public class ProviderTinService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("https://trustbroker-stg-svcs.optum.com:8443/tst/rqns-services-web/services/providerTinService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProviderTinService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "https://trustbroker-stg-svcs.optum.com:8443/tst/rqns-services-web/services/providerTinService?wsdl");
        }
        WSDL_LOCATION = url;
    }
