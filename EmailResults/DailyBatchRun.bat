...
Process.vbs "SendEmail" "FitNesse@aimhealth.com" "vy@aimhealth.com;salagusundharam@aimhealth.com;pv@aimhealth.com;mdoddi@aimhealth.com;rtripathi@aimhealth.com;" "FitNesse - Suite Name: Direct Connect 1.0 - Daily Run" "%sNewTestSetName%"
