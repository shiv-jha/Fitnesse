...
public final class AcaMemberEligibilityService_AcaMemberEligibilityServiceImplPort_Client {
    ...
    public  String acaMeberEligibility() throws java.lang.Exception {
       ...
       String _getEligibleAcaMembersByMbrIDAndClient_planName=null;
        ...
        int iCount=0;
         ...
         if (iCount==1)
         {
        	  sRequestSqlFinal="select * from (select m_adj.mbr_id as mbr_id,m_adj.mbr_mod_id,m_adj.mbr_sub_pln_adj_strt_dt,m_adj.mbr_sub_pln_adj_end_dt,m_glb.mbr_glb_id,vw_clnt.sub_cli_org_nm,vw_clnt.clnt_guid,m_adj.mbr_sbscr_id,m_adj.MBR_CONTR_NBR from";
         ...
         System.out.println(sRequestSqlFinal);
         	ResultSet rs1=DataBaseConnect.getRsList("TEST", sRequestSqlFinal);
         	 while (rs1.next()){
         		...
         		_getEligibleAcaMembersByMbrIDAndClient_eligStrtDt=Utility.formatDateForService(rs1.getString(3));
         		_getEligibleAcaMembersByMbrIDAndClient_eligEndDt=Utility.formatDateForService(rs1.getString(4));
         		_getEligibleAcaMembersByGlbMbrIDAndClient_globalMemberID=rs1.getString(5);
         		_getEligibleAcaMembersByMbrIDAndClient_clientID=rs1.getString(7);
         		_getEligibleAcaMembersByMbrIDAndClient_subscriberID=rs1.getString(8);
         		_getEligibleAcaMembersByMbrIDAndClient_planName=rs1.getString(9);
    ...
    //    java.lang.String _getEligibleAcaMembersByMbrIDAndClient_memberID = "150045";
       // java.lang.String _getEligibleAcaMembersByMbrIDAndClient_modifierID = "543";
     //   java.lang.String _getEligibleAcaMembersByMbrIDAndClient_clientName = "UnitedHealth Group Employee and Individual Commercial - UNET";
        //java.lang.String _getEligibleAcaMembersByMbrIDAndClient_eligStrtDt = "_getEligibleAcaMembersByMbrIDAndClient_eligStrtDt-373489116";
        //java.lang.String _getEligibleAcaMembersByMbrIDAndClient_eligEndDt = "_getEligibleAcaMembersByMbrIDAndClient_eligEndDt-1213995331";
        com.optum.rqns.services.eligiblityTest.ServiceMetaData _getEligibleAcaMembersByMbrIDAndClient_metaData = new com.optum.rqns.services.eligiblityTest.ServiceMetaData();
        _getEligibleAcaMembersByMbrIDAndClient_metaData.setAppId("5317c8af4dd6bec7b46c2083018b8ae6");
        try {
          // _getEligibleAcaMembersByMbrIDAndClient_eligStrtDt = "01/01/2016";
			// _getEligibleAcaMembersByMbrIDAndClient_eligEndDt = "31/01/2016";
			//  String _getEligibleAcaMembersByMbrIDAndClient_eligStrtDt = null;
			//String _getEligibleAcaembersByMbrIDAndClient_eligEndDt = null;
			com.optum.rqns.services.eligiblityTest.AcaMemberEligibilityInfo _getEligibleAcaMembersByMbrIDAndClient__return = port.getEligibleAcaMembersByMbrIDAndClient(_getEligibleAcaMembersByMbrIDAndClient_memberID, _getEligibleAcaMembersByMbrIDAndClient_modifierID, _getEligibleAcaMembersByMbrIDAndClient_clientName, _getEligibleAcaMembersByMbrIDAndClient_eligStrtDt, _getEligibleAcaMembersByMbrIDAndClient_eligEndDt, _getEligibleAcaMembersByMbrIDAndClient_metaData);
           // System.out.println("getEligibleAcaMembersByMbrIDAndClient.result=" + _getEligibleAcaMembersByMbrIDAndClient__return);
           // System.out.println("data is "+_getEligibleAcaMembersByMbrIDAndClient__return.getAcaMemberEligibilityDetails().get(0).clientGuid);
           // System.out.println("data is "+_getEligibleAcaMembersByMbrIDAndClient__return.getAcaMemberEligibilityDetails().get(0).eligibilitySource);
        	System.out.println( "From Service:");
        	 AcaMemberEligibilityDetails oRecord = _getEligibleAcaMembersByMbrIDAndClient__return.getAcaMemberEligibilityDetails().get(0);
        ...
        com.optum.rqns.services.eligiblityTest.ServiceMetaData _getEligibleAcaMembersByGlbMbrIDAndClient_metaData = new com.optum.rqns.services.eligiblityTest.ServiceMetaData();
        _getEligibleAcaMembersByGlbMbrIDAndClient_metaData.setAppId("5317c8af4dd6bec7b46c2083018b8ae6");
        try {
            com.optum.rqns.services.eligiblityTest.AcaMemberEligibilityInfo _getEligibleAcaMembersByGlbMbrIDAndClient__return = port.getEligibleAcaMembersByGlbMbrIDAndClient(_getEligibleAcaMembersByGlbMbrIDAndClient_globalMemberID, _getEligibleAcaMembersByMbrIDAndClient_clientName, _getEligibleAcaMembersByMbrIDAndClient_eligStrtDt, _getEligibleAcaMembersByMbrIDAndClient_eligEndDt, _getEligibleAcaMembersByGlbMbrIDAndClient_metaData);
            System.out.println( "From Service:");
       	 AcaMemberEligibilityDetails oRecord = _getEligibleAcaMembersByGlbMbrIDAndClient__return.getAcaMemberEligibilityDetails().get(0);
